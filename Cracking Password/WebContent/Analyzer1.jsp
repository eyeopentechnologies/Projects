...
<body>
	...
	<div id="navvv3">
	<form action="poular_names" name="loginform" method="post">
	<table width="100%">
			<tr>
		 		<td align="left"><a id="labl1" href="PasswordCreation.jsp">Back</a></td>
		 		<td align="right"><a id="labl1" href="Anayzer2.jsp">Next</a></td>
		...
		<tr>
		 ...
		 try{				
	            ...
	            ResultSet rs=st.executeQuery("select * from wordlist where content='"+newstr+"'");
	            if(rs.next()){
	            	%>	            	
		            	<tr>
							<td colspan="2" align="center">
								<h1><font color="red">You had used a Dictionary Word <%=rs.getString(3)%>.</font></h1>
							</td>
						</tr>
	            	<%
	            }else{
