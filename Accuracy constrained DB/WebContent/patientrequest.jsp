...
<tr>
<td width="648"><h2>Request From Patient</h2></td>
</tr>
<tr></tr>

<tr>
<%Connection con = databasecon.getconnection();
PreparedStatement ps=  con.prepareStatement("select * from consult where doctor =? and status = ?");
String name = (String)session.getAttribute("docid");
ps.setString(1, name);
ps.setString(2, "NO");
...
%>
<%String url = "viewpatientdetail.jsp?pid="+rs.getString("patient");



%>
<td>Patient Name: </td><td><a href = '<%=url %>'><%=rs.getString("patient") %></a></td>
<%} %>
