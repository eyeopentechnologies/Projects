...
<form action="checkdoc.jsp" name="f" method="get" onSubmit="return valid();">
<div style="width:400px;height:300px;">
       <div align="center" class="paragraping1"><font  color="BLUE" size="3">Doctor Login Here</font></div> <br>
