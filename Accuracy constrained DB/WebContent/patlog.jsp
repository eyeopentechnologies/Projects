...
<form action="checkpat.jsp" name="f" method="get" onSubmit="return valid();">
<div style="width:400px;height:300px;">
       <div align="center" class="paragraping1"><font  color="BLUE" size="3">Patient Login Here</font></div> <br>
        <label for="txtEmail" id>
            <font style="color:BLUE;font-size:12px;font-family:verdana">Username:</font></label><br>
        <input id="inputArea" type="text" name="name"/><br>
        <label for="txtWebsite">
            <font style="color:BLUE;font-size:12px;font-family:verdana">Password:</font></label><br><input id="inputArea" type="password" name="pass" />
