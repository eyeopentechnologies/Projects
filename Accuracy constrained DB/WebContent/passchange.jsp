   ...
   <div id="navigation">
      <div id="navbar_link">
        <ul>
           ...
           <li><a href="common1.jsp">Common Data</a></li>
...
<table align="center" width="500">
        ...
        <td width="80"  colspan="4" align="center" class="paragraping"><font color="blue" size="+1">Welcome!&nbsp;&nbsp;<% out.println(rs1.getString(2));%></font></td>
...
<% 
	...
	<td><a onClick="patupdate.jsp" href="patupdate.jsp?<%=s1%>">Update</a></td>
	<!--<td><a onClick="patdelete1.jsp" href="patdelete1.jsp?<%=s1%>">Delete</a></td>-->
	</tr>
		<%
