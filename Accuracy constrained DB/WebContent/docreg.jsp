...
<td width="639" valign="top">
    <table align="center" width="600" style="text-decoration-color: BLUE">
    <form name="f" method="post" action="doctorreg.jsp" onSubmit="return valid();">


<tr>
<td class="paragraping1" colspan="2" valign="top" align="center"><font color="BLUE" size="4">Doctor Register Here</font></td>
</tr>
<tr>
