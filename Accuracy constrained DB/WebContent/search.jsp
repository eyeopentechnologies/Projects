...
<tr>
<td height="44"> </td>
<td width="328">&nbsp;&nbsp;<a href="search.jsp">Search Disease</a></td>
</tr>
<tr>
<td height="44"> </td>
...
<tr>
<td height="22" colspan="3" align="center" bgcolor="green" class="paragraping">Search Disease Details</td>
</tr>
<tr>
<td width="168" height="95" class="paragraping">Search Disease</td>
<td width="300"><input type="text" name="des" value="" id="inputArea"></td>
<td width="125"><input type="submit" name="sub" value="Search"></td>
</tr>
</table>
</td>
</tr>
