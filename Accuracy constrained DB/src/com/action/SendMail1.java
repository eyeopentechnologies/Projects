...
public class SendMail1 extends HttpServlet {
    ...
    private static String[] emailList = new String[10];
       ...
       private static final String SMTP_AUTH_USER = "jpinfotechmail12@gmail.com";                       
       private static final String SMTP_AUTH_PWD  = "jpinfotechmail";
...
return new PasswordAuthentication(username, password);
  ...
  {                                                                                                                                         
    ...
    Authenticator auth = new SendMail1.SMTPAuthenticator();                                                                
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           String msg = request.getParameter("message");
                ...
                emailMsgTxt = msg;
                emailSubjectTxt = sub;
                emailFromAddress = SendMail1.SMTP_AUTH_USER;
    // Add List of Email address to who email needs to be sent to
            ...
            SendMail1 smtpMailSender = new SendMail1();
            try {
            ...
            System.out.println("Sucessfully Sent mail to All Users");
             response.sendRedirect("Query.jsp?msg=mail sent successfully...!");
